        ...
        get() {
            ...
            _ShieldCheck = ImageVector.Builder(
                ...
                path(
                    ...
                    moveTo(5.338f, 1.59f)
                    arcToRelative(61f, 61f, 0f, isMoreThanHalf = false, isPositiveArc = false, -2.837f, 0.856f)
                    arcToRelative(0.48f, 0.48f, 0f, isMoreThanHalf = false, isPositiveArc = false, -0.328f, 0.39f)
                    curveToRelative(-0.554f, 4.157f, 0.726f, 7.19f, 2.253f, 9.188f)
                    arcToRelative(10.7f, 10.7f, 0f, isMoreThanHalf = false, isPositiveArc = false, 2.287f, 2.233f)
                    curveToRelative(0.346f, 0.244f, 0.652f, 0.42f, 0.893f, 0.533f)
                    quadToRelative(0.18f, 0.085f, 0.293f, 0.118f)
                    arcToRelative(1f, 1f, 0f, isMoreThanHalf = false, isPositiveArc = false, 0.101f, 0.025f)
                    arcToRelative(1f, 1f, 0f, isMoreThanHalf = false, isPositiveArc = false, 0.1f, -0.025f)
